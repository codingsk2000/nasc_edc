...
if (isset($_POST['did']) && $_POST['did'] != "") {
    $id = $obj->get_safe_value($_POST['did']);
    $result = $obj->getData('students', '*', array('dept' => $id),'register_no','asc');
} else {
    $obj->redirect('index.php');
}

$dname = $obj->getData('department','dep_name',array('id'=>$id));
...
<body id="body">
    ...
    <hr>
    <h3>EDC: Department Wise Registration Details</h3>
    <h3 class="cname">Department Name: <?php echo strtoupper($dname[0]['dep_name']); ?></h3>
    <div class="container">
